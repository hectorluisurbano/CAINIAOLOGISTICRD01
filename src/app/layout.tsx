          ...
          <div className="container mx-auto flex justify-between items-center">
            ...
            <nav>
              <ul className="flex space-x-6">
                <li><a href="#" className="hover:text-mikado-yellow transition-colors">Dashboard</a></li>
                <li><a href="#" className="hover:text-mikado-yellow transition-colors">Envíos</a></li>
                <li><a href="#" className="hover:text-mikado-yellow transition-colors">Almacén</a></li>
                <li><a href="#" className="hover:text-mikado-yellow transition-colors">Perfil</a></li>
              </ul>
            </nav>
          </div>
        </header>
